...
The first thing you will need to do is revise the chunks below to include the locations of bedtools on your computer.

First we will sort the file created in prior Step.

```{bash}
/Users/mgavery/Downloads/bedtools-2.17.0/bin/bedtools \
sort \
...
Name the columns from the bedtools output

```{r}
DMRwgene <- DMRwgene %>% rename( DMR_chr= V1, DMR_start = V2, DMR_end = V3, DMR_meth.diff = V4,
...
```{r}
geneID_IPA <- left_join(DMRwgene,genes_annot, by = c("gene_attribute" = "Sequence"))
